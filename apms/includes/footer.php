...
?>
              ...
              <li><span class="fa fa-envelope-open-o"></span><a href="business@mail.com" class="mail">
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© <?php echo date('Y');?>  Appointment Management System </p>
